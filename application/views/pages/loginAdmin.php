        ...
        <div class="container login-cont">
            <div class="row">
                <div class="col-10 col-sm-6 col-md-4 col-lg-4 offset-1 offset-sm-3 offset-md-4 offset-lg-4 login-col"><i class="icon ion-lock-combination"></i>
                    <form class="login-form" method="post" action="<?php echo base_url('index.php/UserC/loginAdmin')?>">
            ...
            <!-- <div> <a href="<?php// echo base_url('index.php/userC/signupPages') ?>"> Inscription </a> </div> -->
        </div>
    </section>
